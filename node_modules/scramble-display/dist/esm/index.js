...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-IPUTXJEJ.js
...
var TwistyAlgEditor = (_a15 = class extends ManagedCustomElement {
  ...
  highlightLeaf(leaf) {
    ...
    __privateGet(this, _carbonCopySuffix).textContent = __privateMethod(this, _padSuffix, padSuffix_fn).call(this, __privateGet(this, _textarea).value.slice(leaf[endCharIndexKey]));
...
var _fallback, fallback_fn, _cssCDNForumTweaksElem, _scrollableRegion, _responsiveWrapper, _moveCountElem, _addHeading, addHeading_fn, _a16;
  ...
  async connectedCallback() {
    ...
    if (["/edit/", "/explore/"].includes(pathname)) {
      ...
      if (config.puzzle && !(config.puzzle in puzzles)) {
        const puzzleDescription = (await import("./puzzle-geometry-JCNGBESZ.js")).getPuzzleDescriptionString(config.puzzle);
...
}, _cssCDNForumTweaksElem = new WeakMap(), _scrollableRegion = new WeakMap(), _responsiveWrapper = new WeakMap(), _moveCountElem = new WeakMap(), _addHeading = new WeakSet(), addHeading_fn = function(text, getTextToCopy) {
