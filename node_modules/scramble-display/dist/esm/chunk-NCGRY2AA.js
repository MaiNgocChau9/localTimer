...
var _A, _B, _a;
var Commutator = (_a = class extends AlgCommon {
  ...
  isIdentical(other) {
    const otherAsCommutator = other.as(_a);
    return !!(otherAsCommutator?.A.isIdentical(this.A) && otherAsCommutator?.B.isIdentical(this.B));
  }
  invert() {
    return new _a(__privateGet(this, _B), __privateGet(this, _A));
  }
  *experimentalExpand(iterDir = 1, depth) {
  ...
  toString(experimentalSerializationOptions) {
    return `[${__privateGet(this, _A).toString(experimentalSerializationOptions)}, ${__privateGet(this, _B).toString(experimentalSerializationOptions)}]`;
  }
}, _A = new WeakMap(), _B = new WeakMap(), _a);
var _A2, _B2, _a2;
var Conjugate = (_a2 = class extends AlgCommon {
  constructor(aSource, bSource) {
    super();
  ...
  isIdentical(other) {
    const otherAsConjugate = other.as(_a2);
    return !!(otherAsConjugate?.A.isIdentical(this.A) && otherAsConjugate?.B.isIdentical(this.B));
  }
  invert() {
    return new _a2(__privateGet(this, _A2), __privateGet(this, _B2).invert());
  }
...
}, _A2 = new WeakMap(), _B2 = new WeakMap(), _a2);
var _text, _a3;
var LineComment = (_a3 = class extends AlgCommon {
  ...
  isIdentical(other) {
    ...
    return other.is(_a3) && __privateGet(this, _text) === __privateGet(otherAsLineComment, _text);
  }
  invert() {
    return this;
  }
...
var _quantumWithAmount, _cachedSlashMove, _isSlash, isSlash_fn, _a7;
var Move = (_a7 = class extends AlgCommon {
  constructor(...args) {
    super();
    __privateAdd(this, _isSlash);
    __privateAdd(this, _quantumWithAmount, void 0);
    __privateAdd(this, _cachedSlashMove, void 0);
  ...
  invert() {
    return transferCharIndex(
      this,
      new _a7(
        __privateGet(this, _quantumWithAmount).quantum,
        __privateMethod(this, _isSlash, isSlash_fn).call(this) ? this.amount : -this.amount
      )
    );
  }
  *experimentalExpand(iterDir = 1) {
  ...
  toString(experimentalSerializationOptions) {
    if (experimentalSerializationOptions?.notation !== "LGN") {
      if (__privateMethod(this, _isSlash, isSlash_fn).call(this)) {
        return "/";
      }
    ...
    return __privateGet(this, _quantumWithAmount).quantum.toString(
      experimentalSerializationOptions
    ) + __privateGet(this, _quantumWithAmount).suffix();
  }
  ...
  //   };
  // }
}, _quantumWithAmount = new WeakMap(), _cachedSlashMove = new WeakMap(), _isSlash = new WeakSet(), isSlash_fn = function() {
  return this.isIdentical(__privateGet(this, _cachedSlashMove) ?? __privateSet(this, _cachedSlashMove, new _a7("_SLASH_")));
}, _a7);
  ...
  *experimentalExpand(iterDir = 1, depth) {
  ...
  toString(experimentalSerializationOptions) {
    return square1TupleFormatterInstance.format(
      this,
      experimentalSerializationOptions
    ) ?? `${__privateMethod(this, _unrepeatedString, unrepeatedString_fn).call(this, experimentalSerializationOptions)}${__privateGet(this, _quantumWithAmount2).suffix()}`;
  }
  ...
  //   };
  // }
}, _quantumWithAmount2 = new WeakMap(), _unrepeatedString = new WeakSet(), unrepeatedString_fn = function(experimentalSerializationOptions) {
